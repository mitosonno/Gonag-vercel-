...
const SYS = `Sən Gul-Aisən — QONAQ-ın baş event koordinatoru və sales menecerisiən. 30 illik Azərbaycan toy, nişan, ad günü və korporativ məclis təşkili təcrübənə maliksin. Sən həm peşəkar sales host, həm də QONAQ sisteminin tam ekspertisən.
  ...
  if(!events||events.length===0) return (
    <div style={{position:"fixed",inset:0,zIndex:200,background:"rgba(33,26,22,.4)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",justifyContent:"center"}} onClick={onClose}>
      <div style={{background:"linear-gradient(155deg,rgba(255,255,255,.7),rgba(255,255,255,.35))",backdropFilter:"blur(20px) saturate(160%)",WebkitBackdropFilter:"blur(20px) saturate(160%)",border:"1px solid rgba(255,255,255,.6)",boxShadow:"0 1px 0 rgba(255,255,255,.7) inset, 0 20px 50px -15px rgba(60,40,20,.35)",borderRadius:26,padding:"32px 24px",textAlign:"center",maxWidth:320,width:"90%"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{fontSize:12,color:"rgba(33,26,22,.5)",marginBottom:20,marginTop:4}}>Gul-Ai ilə yeni məclis yaradın</div>
    ...
    <div>
      ...
      <div className="app">
        ...
        <div className="tb">
          ...
          <div className="tbx">
            <div className="pill"><img src="/gul-ai-icon.png" alt="" className="gulico"/><span className="pn">Gul-<span className="ai">Ai</span></span></div>
          </div>
        </div>
        ...
        <div className="body">
          <div className="chat">
            ...
            {busy&&<div className="mw agent"><div className="av a"><img src="/gul-ai-icon.png" style={{width:"70%",height:"70%",objectFit:"contain"}}/></div><div className="bb a tbb"><div className="ds"><span/><span/><span/></div></div></div>}
            <div ref={endRef}/>
          </div>
          {chatWizard&&(()=>{
